...
% this version: quantifies effect of high-pass filtering at diff
% frequencies on detection

categs = {'std','10Hz', '20Hz','30Hz'};
categ_names = {'Standard','10 Hz','20 Hz', '30 Hz'};
...
for ampind = 1:length(categs)
    ...
    if strcmp(categs{ampind},'std')
        rem_art_pca = false;
        filt_hp = false;
    elseif strcmp(categs{ampind},'10Hz')
%         rem_art_pca = true;
...
%         mep_settings.art_chans = 'facial'; 
    ...
    elseif strcmp(categs{ampind},'20Hz')
        filt_hp = true;
        f_hp = 20;
        [b_high, a_high] = butter(2,[f_hp]/22000,'high');
    elseif strcmp(categs{ampind},'30Hz')
        filt_hp = true;
        f_hp = 30;
        [b_high, a_high] = butter(2,[f_hp]/22000,'high');
    end
