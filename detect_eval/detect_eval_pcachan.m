...
% this version: which data/channels to use with PCA to generate artifact
% template
% (orthogonal projection, median, percentile, PCA reconstruction without first PC)

categs = {'std','facial','facial_lfp','all','all_lfp'};
categ_names = {'Standard','Facial','Facial+LFP','All','All+LFP'};
